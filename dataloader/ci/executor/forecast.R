...
option_list = list(
  ...
  make_option(c("-p", "--project_id"), type = "character", default = "world-fishing-827",
              help = "Project ID"),
  make_option(c("-d", "--dataset_id"), type = "character", default = "tech_great_expectations",
              help = "Dataset ID"),
  make_option(c("-a", "--actuals_table"), type = "character", default = "anomaly_detection_actuals",
              help = "Actuals table"),
  make_option(c("-f", "--forecasts_table"), type = "character", default = "anomaly_detection_forecasts",
