...
with DAG(
    "gx_run_vms_anomalies_checkpoints", 
    ...
    for current_expectation_suite_name in [es for es in gx_context.list_expectation_suite_names() if 'anomalies' in es and "vms" in es]:
